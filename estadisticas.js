...
function generarContenidoHTML(jugadorMejorPTS, jugadorMejorAST, jugadorMejorBLK, jugadorMejorSTL, jugadorMejorDRB, jugadorMejorORB, jugadorMejorTOV, jugadorMejorEdad,
    ...
    encabezadoTabla.setAttribute("colspan", 4); // Agregar el atributo colspa
    ...
    const equipoEncabezado = document.createElement("th");
    equipoEncabezado.textContent = "Equipo";
    ...
    filaEncabezado.appendChild(equipoEncabezado);
    ...
    function agregarFila(nombreJugador, tipoEstadistica, valor,equipo) {
        ...
        const equipoValor = document.createElement("td");
        equipoValor.textContent = equipo;

        fila.appendChild(celdaNombreJugador);
        fila.appendChild(celdaTipoEstadistica);
        fila.appendChild(celdaValor);
        fila.appendChild(equipoValor);

        cuerpoTabla.appendChild(fila);
    }

    // Agregar las filas con los datos de los jugadores
    agregarFila(jugadorMejorPTS.player_name, "Puntos", jugadorMejorPTS.PTS,jugadorMejorPTS.team);
    agregarFila(jugadorMejorAST.player_name, "Asistencias", jugadorMejorAST.AST,jugadorMejorAST.team);
    agregarFila(jugadorMejorBLK.player_name, "Bloqueos", jugadorMejorBLK.BLK,jugadorMejorBLK.team);
    agregarFila(jugadorMejorSTL.player_name, "Robos", jugadorMejorSTL.STL,jugadorMejorSTL.team);
    agregarFila(jugadorMejorDRB.player_name, "Rebotes Defensivos", jugadorMejorDRB.DRB,jugadorMejorDRB.team);
    agregarFila(jugadorMejorORB.player_name, "Rebotes Ofensivos", jugadorMejorORB.ORB,jugadorMejorORB.team);
    agregarFila(jugadorMejorTOV.player_name, "Perdidas", jugadorMejorTOV.TOV,jugadorMejorTOV.team);
    agregarFila(jugadorMejorEdad.player_name, "Edad", jugadorMejorEdad.age,jugadorMejorEdad.team);
    agregarFila(jugadorMejorTRB.player_name, "Rebotes Totales", jugadorMejorTRB.TRB,jugadorMejorTRB.team);
    agregarFila(jugadorMasMinutos.player_name, "Minutos Jugados", jugadorMasMinutos.minutes_played,jugadorMasMinutos.team);
    agregarFila(jugadorMejorPorcentaje2.player_name, "Porcentaje de Tiros de 2", jugadorMejorPorcentaje2.two_percent * 100 + "%",jugadorMejorPorcentaje2.team);
    agregarFila(jugadorMejorPorcentaje3.player_name, "Porcentaje de Tiros de 3", jugadorMejorPorcentaje3.three_percent * 100 + "%",jugadorMejorPorcentaje3.team);
    agregarFila(jugadorConMenosFaltas.player_name, "Faltas Personales", jugadorConMenosFaltas.PF,jugadorConMenosFaltas.team);
    agregarFila(jugadorConMasPartidos.player_name, "Partidos jugados", jugadorConMasPartidos.games,jugadorConMasPartidos.team);
    agregarFila(jugadorConMasPartidosTitular.player_name, "Titularidades", jugadorConMasPartidosTitular.games_started,jugadorConMasPartidosTitular.team);
